...
<br>
<div class="container" style="text-align: center;font-weight: bold;font-size: 40px;color: #100f0f">Đơn đã mua</div>
<br>
<table class="container table">
    <c:forEach items="${hoaDonDaMua}" var="dMua">
        <tr class="row">
            <td class="col-2"><img src="../../static/${dMua.chiTietSP.image}" style="width: 100px;height: 100px"></td>
            <td class="col-8"
                style="margin-top: 30px;font-weight: bold;font-size: 20px">${dMua.chiTietSP.sanPham.ten}</td>
            <td class="col-2" style="margin-top: 30px;font-size: 20px"><p>Số lượng:</p>
                <p style="color: red;font-size: 20px">${dMua.soLuong}</p></td>
        </tr>
    </c:forEach>
